...
public class ShippingAddress implements Serializable {
	...
	public String getCountryNameByCountryCode() {
	...
	public ShippingAddress(Long id, String line1, String line2, String city, String countryCode, String postalCode,
			String state, String normalizationStatus, String status, String countryName) {
		super();
		this.id = id;
		this.line1 = line1;
		this.line2 = line2;
	...
	public String toString() {
		return "ShippingAddress [id=" + id + ", line1=" + line1 + ", line2=" + line2 + ", city=" + city
				+ ", countryCode=" + countryCode + ", postalCode=" + postalCode + ", state=" + state
				+ ", normalizationStatus=" + normalizationStatus + ", status=" + status + ", countryName=" + countryName
				+ "]";
	}
